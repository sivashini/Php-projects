...
<head>
  ...
  <title> Admission!! Forgot Password
  </title>
...
data-open="click" data-menu="vertical-menu" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="../index.php">
              ...
              <h3 class="brand-text">Ph.D Admission 2021-22  | Recover Password</h3>
            </a>
          </li>
        ...
        <section class="flexbox-container">
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              ...
              <h4 style="font-weight: bold"> PTU Recover Password</h4>
                  </div>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; <?php echo date('Y');?> <a class="text-bold-800 grey darken-2">PTU </a>, All rights reserved. </span>
