...
if(isset($_POST['submit']))
  {
    ...
    {
    //rename upload file
    $dateofbirthdoc=$dateofbirthdoc.$extensiondoc;
    $residencedoc=$residencedoc.$extensiondoc;
    $nationalitydoc=$nationalitydoc.$extensiondoc;
    $communitydoc=md5($communitydoc).$extensiondoc;
    $specialdoc=md5($specialdoc).$extensiondoc;
    $experiencedoc=md5($experiencedoc).$extensiondoc;
    $gramarksheet=$gramarksheet.$extensiondoc;
    $pgmarksheet=$pgmarksheet.$extensiondoc;
    ...
    $query=mysqli_query($con,"update tbldocument set dateofbirthdoc='$dateofbirthdoc',residencedoc='$residencedoc',nationalitydoc='$nationalitydoc',communitydoc='$communitydoc',specialdoc='$specialdoc',experiencedoc='$experiencedoc',gramarksheet='$gramarksheet',pgmarksheet='$pgmarksheet' where ID='$eid' && uid='$uid'");
...
$eid=$_GET['editid'];
$uid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from tbldocument where ID='$eid' && uid='$uid'");
$cnt=1;
 ...
 <fieldset>
  <h5>Proof of Date of Birth (Birth Certificate/SSLC/HSC)</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="dateofbirthdoc" name="dateofbirthdoc"  type="file" value="<?php echo $row['dateofbirthdoc'];?>" required>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Residence Certificate issued by Tahsildar not older than June, 2021</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="residencedoc" name="residencedoc"  type="file" value="<?php echo $row['residencedoc'];?>" required>
    </div>
</fieldset>                 
</div>
</div>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Nationality Certificate (Aadhaar/Driving License/Passport/EPIC)</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="nationalitydoc" name="nationalitydoc"  type="file" value="<?php echo $row['nationalitydoc'];?>" required>
    </div>
</fieldset>                 
</div>
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Community Certificate (if applicable)</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="communitydoc" name="communitydoc"  type="file" value="<?php echo $row['communitydoc'];?>">
    </div>
</fieldset>                 
</div>
</div>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Certificates for Special Reservation (if applicable)</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="specialdoc" name="specialdoc"  type="file" value="<?php echo $row['specialdoc'];?>">
    </div>
</fieldset>             
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Experience Certificate's</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="experiencedoc" name="experiencedoc"  type="file" value="<?php echo $row['experiencedoc'];?>">
    </div>
</fieldset>             
...
<div class="col-xl-6 col-lg-12">
  ...
  <h5>Graduation Certificate</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="gramarksheet" name="gramarksheet"  type="file" value="<?php echo $row['gramarksheet'];?>" required>
    </div>
</fieldset>
 </div>
...
<div class="col-xl-6 col-lg-12">
  ...
  <h5>Post Graduation Certificate</h5>
   <div class="form-group">
    <input class="form-control white_bg" id="pgmarksheet" name="pgmarksheet"  type="file" value="<?php echo $row['pgmarksheet'];?>" required>
    </div>
</fieldset>
</div>
</div>
