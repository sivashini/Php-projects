...
if(isset($_POST['login']))
  {
    ...
    if($ret>0){
      $_SESSION['uid']=$ret['ID'];
     echo "<script type='text/javascript'> document.location ='admission-form.php'; </script>";
    }
    else{
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            ...
            <img style="height:50px;">
              <h3 class="brand-text"> Admission  | User Login</h3>
            </a>
          </li>
        ...
        <section class="flexbox-container">
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-8 col-10 box-shadow-2 p-0">
              ...
              <h4 style="font-weight: bold"> User Login</h4>
                  </div>
