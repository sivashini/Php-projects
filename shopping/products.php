...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to VEG SHOP!</h1>
                    <p>We have fresh vegetables for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/betroot.jpg" alt="betroot">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Betroot</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pavaka.jpg" alt="pavaka">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bitter gourd</h3>
